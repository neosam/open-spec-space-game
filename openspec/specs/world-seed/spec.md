...
The game SHALL accept an optional `--seed <value>` command-line argument where `<value>` is a 64-bit unsigned integer. When provided, this value MUST be used as the global world seed for all procedural generation.

#### Scenario: Seed provided via CLI
- **WHEN** the game is launched with `--seed 42`
